...
bool SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format)
{
    ...
    const ImRect frame_bb(window->DC.CursorPos + ImVec2(10, 0), window->DC.CursorPos + ImVec2(308, label_size.y + style.FramePadding.y * 2.0f));
...
bool renderer::imgui::elements::functions::slider_float(const char* label, float* v, float v_min, float v_max, const char* format)
{
...
bool SliderScalarStretched(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format)
{
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool renderer::imgui::elements::functions::slider_float_stretched(const char* label, float* v, float v_min, float v_max, const char* format)
{
    return SliderScalarStretched(label, ImGuiDataType_Float, v, &v_min, &v_max, format);
}

bool renderer::imgui::elements::functions::slider_int_stretched(const char* label, int* v, int v_min, int v_max, const char* format)
{
    return SliderScalarStretched(label, ImGuiDataType_S32, v, &v_min, &v_max, format);
}
