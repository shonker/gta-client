...
bool renderer::imgui::elements::functions::hotkey(const char* label, int* k)
{
	...
	ImGui::RenderFrame(bb.Min + ImVec2(10, 0), bb.Max - ImVec2(10, 5), ImColor(35, 42, 51), false, 4);
	...
	window->DrawList->AddText(NULL, 7, bb.Min + ImVec2(18, 13), ImColor(211, 211, 211, 160 + int(Active * 91.f)), (const char*)ICON_FA_KEYBOARD);
	window->DrawList->AddText(bb.Min + ImVec2(40, 7), ImColor(211, 211, 211, 160 + int(Active * 91.f)), buf_display);
...
bool renderer::imgui::elements::functions::hotkey_stretched(const char* label, int* k)
{
	...
	window->DrawList->AddText(bb.Min + ImVec2(10, 7), ImColor(211, 211, 211, 211), label, text_display_end);
